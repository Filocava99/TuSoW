...
import it.unibo.coordination.tusow.akka.TusowAkkaService
...
object Server {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val system = ActorSystem[Nothing](Behaviors.empty, "TusowAkkaServer", conf)
...
class Server(system: ActorSystem[_]) {
    ...
    def run(): Future[Http.ServerBinding] = {
        ...
        val service: HttpRequest => Future[HttpResponse] =
            TusowServiceHandler(new TusowAkkaService(system))
